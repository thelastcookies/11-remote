    ...
    $.fn.datePicker = function (options) {
        return this.each(function (e) {
            ...
            $.fn.datePicker.defaultOptions = {
                ...
                liH: 80,
                theme: "date", //控件样式（1：日期(date)，2：日期+时间(datetime),3:时间(time),4:年月(month),5:年(year)）
                mode: null, //操作模式（滑动模式）
            ...
            if (!opts.show) {
                ...
                that.unbind("change").bind("change", onchange);
            }
            ...
            function init() { //初始化函数
                ...
                $('#d-okBtn').on('click', function (event) {
                    ...
                    that.val($('.d-return-info').html()).change();
            ...
            function renderDom() {
                ...
                monthHtml += '</div>';
                var yearHtml = '<div class="d-date-wrap">';
                yearHtml += '<div class="d-date-mark"></div>';
                yearHtml += '<div class="d-year-wrap d-date-cell" style="width:100%" id="yearScroll"><ul></ul></div>';
                yearHtml += '</div>';
            ...
            function createYear() {
                ...
                function yearScrollEnd(_this) {
                    ...
                    if (initM == 2 && opts.theme != 'month' && opts.theme != 'year') {
                        createDay(opts.monthDay[initM - 1]);
                    }
                    showTxt();
                };
